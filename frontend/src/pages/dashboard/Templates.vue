          ...
          <div class="adset-editor">
            <div v-for="(adset, index) in adsetForms" :key="index" class="adset-card">
              ...
              <div class="inline-fields saved-targeting-fields">
                <el-form-item label="地区组"><el-select v-model="adset.region_group_id" filterable clearable style="width:100%" placeholder="选择已保存地区组" :loading="targetingResourcesLoading" @change="applyRegionGroup(adset, $event)"><el-option v-for="group in regionGroups" :key="group.id" :label="group.name" :value="group.id" /></el-select></el-form-item>
                <el-form-item label="定向包"><el-select v-model="adset.targeting_package_id" filterable clearable style="width:100%" placeholder="选择已保存定向包" :loading="targetingResourcesLoading" @change="applyTargetingPackage(adset, $event)"><el-option v-for="item in targetingPackages" :key="item.id" :label="item.name" :value="item.id" /></el-select></el-form-item>
              </div>
              ...
              <el-collapse class="adset-advanced-settings">
                <el-collapse-item title="人口属性与语言" name="demographics">
              ...
              <el-collapse class="adset-advanced-settings">
                <el-collapse-item title="Advantage+ 与版位" name="placement">
