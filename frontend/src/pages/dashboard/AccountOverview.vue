<template>
  <div class="page"><div class="head"><div><div class="eyebrow">数据中心</div><h2>广告账户消耗总览</h2><p>按账户和币种查看消耗，数据不会跨币种直接相加。</p></div><el-button type="primary" :loading="syncing" @click="sync">回补最近 3 天</el-button></div>
    <el-card shadow="never" class="filters"><el-date-picker v-model="range" type="daterange" value-format="YYYY-MM-DD" start-placeholder="开始日期" end-placeholder="结束日期" @change="load"/><el-button @click="load">刷新</el-button></el-card>
