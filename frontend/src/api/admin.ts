...
export interface CredentialItem { id: string; meta_account_id: string | null; meta_account_name?: string | null; business_id?: string | null; name: string | null; app_id: string | null; token_type: string; source?: string; scopes?: string[]; missing_scopes?: string[]; permission_ready?: boolean; expires_at: string | null; status: string; last_error: string | null; last_verified_at: string | null; is_expired: boolean; access_token_masked?: string | null; linked_account_count?: number; linked_personal_account_count?: number; linked_accounts?: Array<{ id: string; account_id: string; name: string | null; owner_type: string; business_id: string | null }>; created_at: string | null; updated_at: string | null }
